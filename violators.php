                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form method="POST" action="process/process_delete.php" style="display: inline;" 
                                          onsubmit="return confirmDelete('Delete this violator? All associated tickets will be removed!')">
